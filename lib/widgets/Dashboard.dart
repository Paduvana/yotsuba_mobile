...
import 'package:yotsuba_mobile/BottomNavBar.dart';
import 'package:yotsuba_mobile/LogoutPage.dart';
import 'package:yotsuba_mobile/ReservationItemWidget.dart';
...
class _DashboardState extends State<Dashboard> {
  ...
  switch (_selectedIndex) {
    ...
    case 1:
      return const Center(
          child: Text('New Reservation Screen', style: TextStyle(fontSize: 24)));
    case 2:
      return const Center(
          child: Text('Reservation Confirmed Screen', style: TextStyle(fontSize: 24)));
    case 3:
      return const Center(
